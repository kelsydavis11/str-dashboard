...
.pg-btn { height:34px; box-sizing:border-box; display:inline-flex; align-items:center; font-size:13px; font-weight:500;
  padding:0 15px; border-radius:6px; border:1px solid var(--rule-strong); background:var(--surface); color:var(--ink); text-decoration:none; }
...
.stButton > button, [data-testid="stBaseButton-secondary"] {
  border-radius:6px !important; border:1px solid var(--rule-strong) !important; background:var(--surface) !important;
  color:var(--ink) !important; font-size:13px !important; font-weight:500 !important; }
